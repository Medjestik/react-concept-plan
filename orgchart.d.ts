declare class OrgChart extends OrgChartBase {
	...
	static collapsedChildrenTotalCount(
		chart: OrgChart,
		node: OrgChart.node
	): number;
	 ...
	 */
	static roundPathCorners(
		commands: string | Array<Array<any>>,
		radius: number,
...
declare namespace OrgChart {
	...
	interface undoRedoUI {
		...
		on(
			type: 'change',
			listener: (sender: undoRedoUI, args: any) => void | boolean
		): undoRedoUI;
		/**
	...
	interface options {
		...
		editForm?: {
			...
			elements?: Array<
				OrgChart.editFormElement | Array<OrgChart.editFormElement>
			>;
		};
	}
